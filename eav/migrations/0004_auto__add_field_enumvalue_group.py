...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnumValue.group'
        db.add_column('eav_enumvalue', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='value', null=True, to=orm['eav.EnumGroup']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'EnumValue.group'
        db.delete_column('eav_enumvalue', 'group_id')
    ...
    models = {
        ...
        'eav.enumvalue': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'value'", 'null': 'True', 'to': "orm['eav.EnumGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
