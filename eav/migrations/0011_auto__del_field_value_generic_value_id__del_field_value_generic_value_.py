...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Value.generic_value_id'
        db.delete_column('eav_value', 'generic_value_id')

        # Deleting field 'Value.generic_value_ct'
        db.delete_column('eav_value', 'generic_value_ct_id')

    def backwards(self, orm):
        # Adding field 'Value.generic_value_id'
        db.add_column('eav_value', 'generic_value_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Value.generic_value_ct'
        db.add_column('eav_value', 'generic_value_ct',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='value_values', null=True, to=orm['contenttypes.ContentType'], blank=True),
                      keep_default=False)
