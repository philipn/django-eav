...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('eav_pagelink', (
            ('page_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('eav', ['PageLink'])

        # Adding field 'Value.value_page'
        db.add_column('eav_value', 'value_page',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='eav_value', unique=True, null=True, to=orm['eav.PageLink'], blank=True),
                      keep_default=False)

        # Adding field 'Value.value_schedule'
        db.add_column('eav_value', 'value_schedule',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='eav_value', unique=True, null=True, to=orm['eav.WeeklySchedule'], blank=True),
                      keep_default=False)
