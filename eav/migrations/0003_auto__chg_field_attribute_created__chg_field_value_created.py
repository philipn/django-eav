...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('eav_attribute', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Value.created'
        db.alter_column('eav_value', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    def backwards(self, orm):

        # Changing field 'Attribute.created'
        db.alter_column('eav_attribute', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Value.created'
        db.alter_column('eav_value', 'created', self.gf('django.db.models.fields.DateTimeField')())
    models = {
