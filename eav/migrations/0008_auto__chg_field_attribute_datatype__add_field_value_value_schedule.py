...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('eav_attribute', 'datatype', self.gf('eav.fields.EavDatatypeField')(max_length=8))
        # Adding field 'Value.value_schedule'
        db.add_column('eav_value', 'value_schedule',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='eav_value', unique=True, null=True, to=orm['eav.WeeklySchedule']),
                      keep_default=False)

    def backwards(self, orm):

        # Changing field 'Attribute.datatype'
        db.alter_column('eav_attribute', 'datatype', self.gf('eav.fields.EavDatatypeField')(max_length=6))
        # Deleting field 'Value.value_schedule'
        db.delete_column('eav_value', 'value_schedule_id')
    ...
    models = {
        ...
        'eav.value': {
            ...
            'value_schedule': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'eav_value'", 'unique': 'True', 'null': 'True', 'to': "orm['eav.WeeklySchedule']"}),
